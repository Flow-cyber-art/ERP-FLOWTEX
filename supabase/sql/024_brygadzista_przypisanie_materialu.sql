-- ============================================================
-- Fix: "Brak uprawnień (rola: Brygadzista, wymagane: {Admin})" przy
-- dodawaniu materiału pomocniczego z magazynu w raporcie dziennym.
--
-- report-screen.tsx od dawna udostępnia brygadziście "+ Dodaj materiał"
-- (ten sam mechanizm ręcznego wyboru partii co panel Admina w
-- builds-screen.tsx) — ale assign_material_batches_to_build (009, potem
-- 018) zawsze wymagała roli Admin. Brygadzista mógł się normalnie
-- zalogować i pracować na reszcie raportu, tylko akurat to jedno
-- wywołanie RPC odrzucało go po stronie bazy. Jedyna zmiana względem 018:
-- assert_role dopuszcza teraz też Brygadzistę — logika (w tym fix FK z
-- 018) bez zmian.
-- Uruchom PO 018. Bezpieczne do wielokrotnego wklejenia.
-- ============================================================
